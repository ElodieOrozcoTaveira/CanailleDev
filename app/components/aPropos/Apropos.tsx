...
export default function Apropos() {
  return(
    <div className="container-apropos">
      ...
      <p className="container-apropos__p">
        Aujourd’hui, je conçois des applications web avec passion, rigueur et créativité, toujours avec l’envie d’apprendre et de m’améliorer.
      </p>

      <p className="container-apropos__p">
        Curieuse et persévérante, j’aime comprendre autant le pourquoi que le comment, et proposer des interfaces agréables avec un code propre.
      </p>
