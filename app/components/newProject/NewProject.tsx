    ...
    <>
        ...
        <div className="swipper-wrapper-custom">
            ...
            {projets.map((projet) => (
              ...
              <div key={projet.id} className="projets-container__id" data-id={projet.id}>
                <Link
              href={projet.url}
            ...
            >
                <Image className="projets-container__img"  src={projet.image} alt={projet.titre} width={projet.width} height={projet.height} />
