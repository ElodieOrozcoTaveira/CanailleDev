...
export default function NewPrestations() {
    ...
    return (
        <>
            ...
            <h2 className="prestations-h2">Prestations</h2>
            <h3 className="prestations-h3">Prestations</h3>
                    ...
                    {prestations.map((service) => {
                        ...
                        return (
                            <SwiperSlide key={service.id}>
                                <div className="prestations-container__id" data-id={service.id}>
                                    <IconComponent className="prestations-container__icon" size={48} />
                                    <h4 className="prestations-container__sujet">{service.sujet}</h4>
