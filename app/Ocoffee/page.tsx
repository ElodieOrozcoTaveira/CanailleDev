  ...
  return (
    <>
      ...
      <div className="container-Ocoffee">
        <h1 className="container-Ocoffee__h1">O&apos;Coffee - Site de vente de cafés</h1>
        <div className="container-Ocoffee__underline"></div>
        <p className="container-Ocoffee__p">
         <span className='container-Ocoffee__span'>O&apos;Coffee</span> est mon premier site web de vente de cafés développé dans le cadre de ma formation en développement web.
         ...
         <span className='container-Ocoffee__span'>O&apos;Coffee</span> m’a permis de mettre en pratique les bases du développement Back-End, la gestion des routes, le rendu côté serveur et l’organisation d’un projet web complet.
        </p>
      </div>
